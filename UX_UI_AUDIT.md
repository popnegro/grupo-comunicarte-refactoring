...
5. El panel Media Kit recibe foco al abrirse, permite cerrar con Escape y conserva controles táctiles accesibles.
...
3. Estados interactivos principales incorporan foco visible.
...
- Build y typecheck del branch.
- Prueba runtime desktop/mobile.
- Scroll con selección activa.
- Mapa + filtros + detalle + Selection Bar simultáneamente.
- Apertura/cierre de Media Kit y navegación teclado.
- Verificación visual de footer compacto.
...
## Estado
P1/P2 implementados de forma incremental. Pendiente validación final de build/deployment y prueba visual/E2E.