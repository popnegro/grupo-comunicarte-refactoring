          ...
          >
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                {isReservado && (
                  <div className="mt-3 p-3 bg-gray-50 rounded-xl border border-gray-200 text-xs text-gray-700 leading-relaxed">
                    <p className="font-semibold text-gray-900 mb-0.5">Soporte actualmente ocupado</p>
                    <p>Puedes incluirlo en tu Media Kit para consultar fecha de liberación o alternativas en la misma zona.</p>
                  </div>
                )}
                {isReservado && item.availableFrom && (
                  <p className="mt-2 text-xs text-gray-500 font-medium">
                    Fecha estimada de liberación: <span className="text-gray-900 font-semibold">{item.availableFrom}</span>
                  </p>
                )}
              </div>
            </div>
