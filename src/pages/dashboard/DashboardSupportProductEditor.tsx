...
type FormState = {
  ...
  mobile: { pantalla: string; resolucion: string; spot_duration: string; minimum_daily_outings: string; recorrido: string; operation_days: string; monthly_impacts: string };
...
const emptyForm: FormState = {
  ...
  mobile: { pantalla: '', resolucion: '', spot_duration: '', minimum_daily_outings: '', recorrido: '', operation_days: '', monthly_impacts: '' },
